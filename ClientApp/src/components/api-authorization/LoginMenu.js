...
export class LoginMenu extends Component {
    ...
    anonymousView(registerPath, loginPath) {
        return (<Fragment>
            <NavItem>
                <NavLink tag={Link} className="text-dark" to={registerPath}><Button color='primary' className='me-md-2 mb-1 mb-lg-0' outline>Registrate</Button></NavLink>
            </NavItem>
            <NavItem>
                <NavLink tag={Link} className="text-dark" to={loginPath}><Button color='' className='btn-primary'>Inicia sesión</Button></NavLink>
            </NavItem>
        </Fragment>);
    }
}
